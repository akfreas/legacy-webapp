...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApprovedBetaTesters'
        db.create_table(u'EventApp_approvedbetatesters', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('time_used', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'EventApp', ['ApprovedBetaTesters'])


    def backwards(self, orm):
        # Deleting model 'ApprovedBetaTesters'
        db.delete_table(u'EventApp_approvedbetatesters')
