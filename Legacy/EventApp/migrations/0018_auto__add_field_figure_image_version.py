...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Figure.image_version'
        db.add_column(u'EventApp_figure', 'image_version',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Figure.image_version'
        db.delete_column(u'EventApp_figure', 'image_version')
    ...
    models = {
        ...
        u'EventApp.figure': {
            ...
            'image_version': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
