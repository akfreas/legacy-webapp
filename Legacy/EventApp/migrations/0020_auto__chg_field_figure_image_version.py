...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Figure.image_version'
        db.alter_column(u'EventApp_figure', 'image_version', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'Figure.image_version'
        db.alter_column(u'EventApp_figure', 'image_version', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'EventApp.figure': {
            ...
            'image_version': ('django.db.models.fields.IntegerField', [], {}),
