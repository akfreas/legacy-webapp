...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventUser.birthday'
        db.add_column(u'EventApp_eventuser', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventUser.birthday'
        db.delete_column(u'EventApp_eventuser', 'birthday')
